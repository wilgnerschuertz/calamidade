...
import 'app/(public)/affiliated_first_action/presentation/affiliated_first_action_page.dart' as a4;
import 'app/(public)/ask_help/ask_help_page.dart' as a5;
...
List<RouteEntity> get routes => [
  ...
  RouteEntity(
    ...
    routeBuilder: (ctx, settings) => Routefly.defaultRouteBuilder(
      ctx,
      settings,
      const a4.AffiliatedFirstActionPage(),
    ),
  ),
  RouteEntity(
    key: '/ask_help',
